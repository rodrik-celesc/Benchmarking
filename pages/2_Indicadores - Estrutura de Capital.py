...
# Dívida Bruta / Ativo Total
if selecao == 'Dívida Bruta / Ativo Total':
    st.title('Dívida Bruta / Ativo Total')
    # st.write('**Descrição:** Dívida Bruta / Ativo Total')
    # st.write('**Fórmula:** (Empréstimos e Financiamentos) / (Ativo Total) * 100')
    ind.estrutura_capital_1()